...
-----------------------------------------------------------------------------------------------------------------------------------------
-- SETSDATA   TESTE QUALQUER COISA APAGAR DA LINHA 87 A 102
-----------------------------------------------------------------------------------------------------------------------------------------
		...
		if not vRP.checkBanned(steam) then
			...
			if infoAccount then
				if infoAccount["whitelist"] then
					...
					deferrals.done("Você não possui WHITELIST na cidade, libere sua HEX em: https://discord.gg/NHyffzKm6e - HEX: "..steam.."")
				end
			else
...
function vRP.characterChosen(source,user_id,model,locate)
	...
	if model ~= nil then
		...
		vRP.generateItem(user_id,"premium",1,false)
		vRP.generateItem(user_id,"dollars",20000,false)
		vRP.generateItem(user_id,"water",5,false)
		vRP.generateItem(user_id,"sandwich",5,false)
