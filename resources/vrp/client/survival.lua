...
AddEventHandler("vRP:playerActive",function(user_id,name)
	...
	SetDiscordAppId(1066024509943066746)  -- id rich presence
	SetDiscordRichPresenceAsset("logo_sem_fundo_oficial") -- nome da logo
	SetRichPresence("#"..user_id.." "..name)
	SetDiscordRichPresenceAssetSmall("logo_sem_fundo_oficial")
	SetDiscordRichPresenceAssetText("Alameda City")
	SetDiscordRichPresenceAssetSmallText("Alameda City")
	SetDiscordRichPresenceAction(1,"Alameda City","connect ")
