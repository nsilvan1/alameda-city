...
-- VRP:MECHANICSERVICE
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("vRP:MechanicService")
AddEventHandler("vRP:MechanicService",function(status)
	LocalPlayer["state"]["Mechanic"] = status
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VRP:BURGERSHOTSERVICE
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("vRP:BurgershotService")
AddEventHandler("vRP:BurgershotService",function(status)
	LocalPlayer["state"]["Burgershot"] = status
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VRP:PHONE
-----------------------------------------------------------------------------------------------------------------------------------------
