                ...
                if distance <= 10 then
                    ...
                    if distance <= 2 then
                        if IsControlJustPressed(1,38) and vSERVER.CheckPerm(k) and not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 101 then
                            ...
                            TriggerEvent("Notify","verde",Config_Rotas.Notify.StartRoute)
            ...
            if distance <= 10 then
                ...
                if distance <= 2 then
                    if IsControlJustPressed(1,38) and time_seconds <= 0 and not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 101 then
                        ...
                        --TriggerEvent("Notify","vermelho","Cancelando",5000)
	...
	while true do
		...
		if in_service then
			...
			if IsControlJustPressed(1,168) then
                ...
                position = 1
                time_seconds = 0
                TriggerEvent("Notify","vermelho",Config_Rotas.Notify.StopService,5000)
