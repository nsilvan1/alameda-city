$(document).ready(function() {
    ...
    window.addEventListener("message", function(event) {
        ...
        if (item["addbutton"] == true) {
            ...
            var aa = (`<button data-menu="` + item["menuid"] + `"class="b btn"><div class="title">` + item["title"] + `</div><div class="description" >` + item["description"] + `</div></button>`)
            $(".container").append(aa);
            submenus.push(aa);
        }
    ...
    function goback() {
        var gobackbutton = (`<button id="goback" class ="btn"><div class="titles">Voltar</div></button>`);
