		...
		if not LocalPlayer["state"]["Commands"] and not LocalPlayer["state"]["Handcuff"] and not menuOpen and MumbleIsConnected() then
			...
			if GetEntityHealth(ped) > 101 then
				...
				if LocalPlayer["state"]["Police"] then
					...
					exports["dynamic"]:AddButton("Fardamento Comando","Clique para vestir.","player:presetFunctions","23","prePolice",true)
					exports["dynamic"]:AddButton("Fardamento Instrutor","Clique para vestir.","player:presetFunctions","22","prePolice",true)
					exports["dynamic"]:AddButton("Fardamento C.O.R.E.","Clique para vestir.","player:presetFunctions","1","prePolice",true)
					exports["dynamic"]:AddButton("Fardamento D.I.G.","Clique para vestir.","player:presetFunctions","7","prePolice",true)
					exports["dynamic"]:AddButton("Fardamento G.R.A.R.","Clique para vestir.","player:presetFunctions","4","prePolice",true)
					exports["dynamic"]:AddButton("Fardamento G.R.A.E.R.","Clique para vestir.","player:presetFunctions","6","prePolice",true)
					exports["dynamic"]:AddButton("Fardamento G.T.M.","Clique para vestir.","player:presetFunctions","2","prePolice",true)
					exports["dynamic"]:AddButton("Fardamento de Policia.","Clique para vestir.","player:presetFunctions","3","prePolice",true)
					exports["dynamic"]:AddButton("Fardamento Recruta.","Clique para vestir.","player:presetFunctions","5","prePolice",true)
				...
				elseif LocalPlayer["state"]["Paramedic"] then
					exports["dynamic"]:AddButton("Fardamento de Diretor(a).","Clique para vestir.","player:presetFunctions","10","preMedic",true)
					exports["dynamic"]:AddButton("Fardamento de Médico(a).","Clique para vestir.","player:presetFunctions","9","preMedic",true)
					exports["dynamic"]:AddButton("Fardamento de Paramédico(a).","Clique para vestir.","player:presetFunctions","16","preMedic",true)
					exports["dynamic"]:AddButton("Fardamento de Mergulhador(a).","Clique para vestir.","player:presetFunctions","17","preMedic",true)
