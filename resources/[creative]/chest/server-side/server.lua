...
function cRP.checkIntPermissions(chestName)
	...
	if user_id then
		if chestName == "trayShot" or chestName == "trayShot1" or chestName == "trayShot2" or chestName == "trayShot3" or chestName == "trayPops" then
			return true
		end
...
function cRP.storeItem(nameItem,slot,amount,target,chestName)
	...
	local user_id = vRP.getUserId(source)
	if user_id then
		if chestName ~= "trayShot" and chestName ~= "trayPops" then
