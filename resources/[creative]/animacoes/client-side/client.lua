...
local animacoes = {
	...
	["capo"] = { dict = "anim@heists@box_carry@" , anim = "idle" , andar = true , loop = true , extra = function()
		--TriggerServerEvent("carregarobjeto","imp_prop_impexp_front_bumper_02a",49,28422,0.0,0.1,0.05,0.0,0.0,0.0)
        vRP.createObjects("anim@heists@box_carry@","idle","prop_car_bonnet_01",49,28422,0.0,-0.1,-0.25,0.0,0.0,0.0)
	end },
	...
	["sentarbug"] = { anim = "PROP_HUMAN_SEAT_CHAIR_MP_PLAYER" },
