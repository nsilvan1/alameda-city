vehicleCustomisationPrices = {
	cosmetics = 2000,
	respray = 1500,
	engines = { 9999999, 40000, 50000, 70000, 80000, 100000 },
	brakes = { 9999999, 30000, 40000, 50000, 60000, 70000 },
	transmission = { 9999999, 30000, 40000, 50000, 60000, 70000 },
	suspension = { 9999999, 20000, 30000, 40000, 50000, 60000 },
	shield = { 9999999, 50000, 70000, 80000, 10000, 120000 },
	turbo = 15000,
	wheels = 2500,
	customwheels = 1500,
	wheelsmoke = 750,
...
vehicleWheelOptions = {
	{
		category = "Customização de Rodas",
		id = -1,
		wheelID = 23
	},{
		category = "Tyre Smoke",
