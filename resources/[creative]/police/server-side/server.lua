...
local preset = {
	["mp_m_freemode_01"] = {
		...
		["pants"] = { item = 87, texture = 11 },  --calca
		...
		["shoes"] = { item = 52, texture = 0 }, --sapatos
		["tshirt"] = { item = 15, texture = 0 }, --camisa
		["torso"] = { item = 1, texture = 12 }, --jaqueta
		["accessory"] = { item = 11, texture = 0 }, --acessorios
	...
	["mp_f_freemode_01"] = {
		...
		["tshirt"] = { item = 15, texture = 0 }, --camisa
		["torso"] = { item = 1, texture = 14 }, --jaqueta
...
RegisterCommand('ptr', function(source,args,rawCommand)
    ...
    if user_id then
		...
		TriggerClientEvent("Notify",source,"amarelo", "Atualmente <b>"..paramedicos.."</b> Oficial em serviço.",5000)
		-- if parseInt(paramedicos) > 0 then
		-- 	TriggerClientEvent("Notify",source,"amarelo", oficiais_nomes)
		-- end
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
...
RegisterCommand('ems', function(source,args,rawCommand)
    ...
    if user_id then
		...
		TriggerClientEvent("Notify",source,"amarelo", "Atualmente <b>"..paramedicos.."</b> Paramédico em serviço.",5000)
		-- if parseInt(paramedicos) > 0 then
		-- 	TriggerClientEvent("Notify",source,"amarelo", oficiais_nomes)
		-- end
	end
...
RegisterCommand('mec', function(source,args,rawCommand)
    ...
    if user_id then
		...
		TriggerClientEvent("Notify",source,"amarelo", "Atualmente <b>"..paramedicos.."</b> Mecânico em serviço.",5000)
		-- if parseInt(paramedicos) > 0 then
		-- 	TriggerClientEvent("Notify",source,"amarelo", oficiais_nomes)
		-- end
	end
