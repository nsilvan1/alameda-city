...
function cRP.checkRolling()
	...
	if user_id and wheelActive == 0 then
		...
		-- if vRP.tryGetInventoryItem(user_id,"fichas",5000,true) or vRP.tryGetInventoryItem(user_id,"dollars",5000,true) or vRP.paymentFull(user_id,5000) then
		if vRP.tryGetInventoryItem(user_id,"fichas",5000,true) then
...
AddEventHandler("luckywheel:Payment",function()
	...
	if user_id and wheelPayments[user_id] then
		if wheelPayments[user_id] == 1 then
			vRP.giveInventoryItem(user_id,"dildo",1,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>1</b> vibrador na roleta.",5000)
		elseif wheelPayments[user_id] == 2 then
			vRP.giveInventoryItem(user_id,"dollars",2500,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$2.500</b> na roleta.",5000)		
		elseif wheelPayments[user_id] == 3 then
			vRP.giveInventoryItem(user_id,"dollars",20000,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$20.000</b> na roleta.",5000)
		elseif wheelPayments[user_id] == 4 then
			vRP.giveInventoryItem(user_id,"fichas",10000,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>10.000</b> fichas na roleta.",5000)
		elseif wheelPayments[user_id] == 5 then
			local identity = vRP.userIdentity(user_id)
			wheelBonus[identity["steam"]] = true
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>+1</b> rodada bonus na roleta.",5000)
		elseif wheelPayments[user_id] == 6 then
			vRP.giveInventoryItem(user_id,"dollars",5000,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$5.000</b> na roleta.",5000)
		elseif wheelPayments[user_id] == 7 then
			vRP.giveInventoryItem(user_id,"dollars",30000,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$30.000</b> na roleta.",5000)
		elseif wheelPayments[user_id] == 8 then
			vRP.giveInventoryItem(user_id,"fichas",15000,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>15.000</b> fichas na roleta.",5000)
		elseif wheelPayments[user_id] == 9 then
			vRP.giveInventoryItem(user_id,"teddy",1,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>1</b> teddy na roleta.",5000)			
		elseif wheelPayments[user_id] == 10 then
			vRP.giveInventoryItem(user_id,"dollars",7500,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$7.500</b> na roleta.",5000)
		elseif wheelPayments[user_id] == 11 then
			vRP.giveInventoryItem(user_id,"fichas",20000,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>20.000</b> fichas na roleta.",5000)
		elseif wheelPayments[user_id] == 12 then
			local identity = vRP.userIdentity(user_id)
			vRP.execute("accounts/infosUpdategems",{ steam = identity["steam"], gems = 10 })
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>10</b> gemas na roleta.",5000)
		elseif wheelPayments[user_id] == 13 then
			vRP.giveInventoryItem(user_id,"backpack",1,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>1</b> mochila na roleta.",5000)			
		elseif wheelPayments[user_id] == 14 then
			vRP.giveInventoryItem(user_id,"dollars",10000,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$10.000</b> na roleta.",5000)
		elseif wheelPayments[user_id] == 15 then
			vRP.giveInventoryItem(user_id,"dollars",40000,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$40.000</b> na roleta.",5000)
		elseif wheelPayments[user_id] == 16 then
			vRP.giveInventoryItem(user_id,"fichas",25000,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>25.000</b> fichas na roleta.",5000)
		elseif wheelPayments[user_id] == 17 then
			vRP.giveInventoryItem(user_id,"watch",1,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>1</b> relógio na roleta.",5000)			
		elseif wheelPayments[user_id] == 18 then
			vRP.giveInventoryItem(user_id,"dollars",15000,true)
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$15.000</b> na roleta.",5000)
		...
		elseif wheelPayments[user_id] == 20 then
			...
			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$25.000</b> na roleta.",5000)
		end
...
-- 			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$15.000</b> na roleta.",5000)
-- 		elseif wheelPayments[user_id] == 11 then
-- 			vRP.giveInventoryItem(user_id,"coins",750,true)
-- 			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>750</b> alameda coins na roleta.",5000)
-- 		elseif wheelPayments[user_id] == 4 then
-- 			vRP.giveInventoryItem(user_id,"coins",1000,true)
-- 			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>1.000</b> alameda coins na roleta.",5000)
-- 		elseif wheelPayments[user_id] == 14 then
-- 			vRP.giveInventoryItem(user_id,"dollars",10000,true)
-- 			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$10.000</b> na roleta.",5000)
-- 		elseif wheelPayments[user_id] == 5 then
-- 			local identity = vRP.userIdentity(user_id)
-- 			wheelBonus[identity["steam"]] = true
-- 			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>+1</b> rodar na roleta.",5000)
-- 		elseif wheelPayments[user_id] == 6 then
-- 			vRP.giveInventoryItem(user_id,"dollars",5000,true)
-- 			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$5.000</b> na roleta.",5000)
-- 		elseif wheelPayments[user_id] == 7 then
...
-- 			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$20.000</b> na roleta.",5000)
-- 		elseif wheelPayments[user_id] == 8 then
-- 			vRP.giveInventoryItem(user_id,"coins",3500,true)
-- 			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>3.500</b> alameda coins na roleta.",5000)
-- 		elseif wheelPayments[user_id] == 10 then
-- 			vRP.giveInventoryItem(user_id,"dollars",7500,true)
-- 			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$7.500</b> na roleta.",5000)
-- 		elseif wheelPayments[user_id] == 12 then
...
-- 			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$22.500</b> na roleta.",5000)
-- 		elseif wheelPayments[user_id] == 16 then
-- 			vRP.giveInventoryItem(user_id,"coins",5000,true)
-- 			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>5.000</b> alameda coins na roleta.",5000)
-- 		elseif wheelPayments[user_id] == 18 then
-- 			vRP.giveInventoryItem(user_id,"dollars",12500,true)
-- 			TriggerClientEvent("Notify",source,"verde","Você ganhou <b>$12.500</b> na roleta.",5000)
-- 		elseif wheelPayments[user_id] == 19 then
-- 			local vehName = "silvia"
-- 			local vehicle = vRP.query("vehicles/selectVehicles",{ user_id = parseInt(user_id), vehicle = vehName })
-- 			if vehicle[1] then
