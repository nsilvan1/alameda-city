...
RegisterCommand("nc",function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if user_id then
		if vRP.hasGroup(user_id,"Moderator") or vRP.hasGroup(user_id,"Suporte") then
			vRPC.noClip(source)
		end
	end
end)
...
RegisterCommand("tptome",function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if user_id then
		if vRP.hasGroup(user_id,"Moderator") or vRP.hasGroup(user_id,"Suporte") and parseInt(args[1]) > 0 then
...
RegisterCommand("anuncio",function(source,args,rawCommand)
	...
	if user_id then
		if vRP.hasPermission(user_id,"Admin") then
			...
			TriggerClientEvent("Notify",-1,"branco",message,30000)
		end
	end
end)
...
RegisterCommand("prefeitura",function(source,args,rawCommand)
	...
	if user_id then
		if vRP.hasPermission(user_id,"Admin") then
			...
			TriggerClientEvent("Notify",-1,"roxo",message.."<br><b>Mensagem da Prefeitura </b>",60000)
		end
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- CONSOLE POLICE
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterCommand("anuncio190",function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if user_id then
		if vRP.hasGroup(user_id,"Police") then
			...
			TriggerClientEvent("Notify",-1,"vermelhopolice",message.."<br><b>Mensagem da Policia </b>",60000)
		end
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
...
RegisterCommand("anunciomec",function(source,args,rawCommand)
	...
	if user_id then
		if vRP.hasGroup(user_id,"Mechanic") then
			...
			TriggerClientEvent("Notify",-1,"amarelomec",message.."<br><b>Mensagem da Mecanica </b>",60000)
		end
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
