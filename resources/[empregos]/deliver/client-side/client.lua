...
Citizen.CreateThread(function()
	local initList = {
		{ -1177.01,-904.31,13.6,"Burgershot",1.0,1.5,"Trabalhar de Delivery" }
	}
...
AddEventHandler("deliver:Starting",function(Init)
	if Cds[Init] then
		if Starting then
			Starting = false
			exports["target"]:LabelText("deliver:"..Init,"Trabalhar de Delivery")
			...
			Locate = Init
			Starting = true
			exports["target"]:LabelText("deliver:"..Init,"Finalizar Trabalho")
